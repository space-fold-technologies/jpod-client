#ifndef __CLIENT_DOMAIN_CONTAINERS_STOP_CONTAINER_COMMAND__
#define __CLIENT_DOMAIN_CONTAINERS_STOP_CONTAINER_COMMAND__
...
{
    class stop_command : public core::commands::sub_command, public core::operations::operation_listener
    {
    public:
        stop_command();
...
#endif //__CLIENT_DOMAIN_CONTAINERS_STOP_CONTAINER_COMMAND__