#ifndef __CLIENT_DOMAIN_CONTAINERS_START_CONTAINER_COMMAND__
#define __CLIENT_DOMAIN_CONTAINERS_START_CONTAINER_COMMAND__
...
{
    class start_command : public core::commands::sub_command, public core::operations::operation_listener
    {
    public:
        start_command();
...
#endif // __CLIENT_DOMAIN_CONTAINERS_START_CONTAINER_COMMAND__