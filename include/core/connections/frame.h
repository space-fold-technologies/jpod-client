#ifndef __CLIENT_CORE_CONNECTIONS_FRAME__
#define __CLIENT_CORE_CONNECTIONS_FRAME__
...
namespace core::connections
{
    ...
    inline std::vector<uint8_t> encode_frame(operation_target target, request_operation operation, const std::vector<uint8_t> &data)
    {
    ...
    inline frame decode_frame(const std::vector<uint8_t> &data)
    {
        ...
        frm.operation = static_cast<response_operation>(data.at(0) & _header_operation_mask);
...
#endif // __CLIENT_CORE_CONNECTIONS_FRAME__